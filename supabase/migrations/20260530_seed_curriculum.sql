...
BEGIN
  ...
  INSERT INTO tracks (id, slug, title_en, title_bn, description_en, description_bn, price_bdt, is_free, difficulty, estimated_hours, tier, published) VALUES
    ...
    ('a1000002-0002-4000-8000-000000000001', 'git-version-control', 'Git & Version Control', 'গিট ও ভার্সন কন্ট্রোল', 'Track code changes with Git and GitHub.', 'গিট ও গিটহাব দিয়ে কোড ট্র্যাকিং।', 2500, false, 'intermediate', 10, 2, false),
